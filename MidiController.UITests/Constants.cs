namespace MidiController.UITests;

public class Constants
{
    public readonly static string WebAssemblyDefaultUri = "http://localhost:5001/";
    public readonly static string iOSAppName = "com.parazite.MidiController";
    public readonly static string AndroidAppName = "com.parazite.MidiController";
