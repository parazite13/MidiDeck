namespace MidiDeck.UITests;

public class Constants
{
    public readonly static string WebAssemblyDefaultUri = "http://localhost:5001/";
    public readonly static string iOSAppName = "com.parazite.MidiDeck";
    public readonly static string AndroidAppName = "com.parazite.MidiDeck";
